...
<html lang="en">
    <head>
        ...
        <title>Services - Stayscape Services</title>
        <link
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1
                            class="fw-bold mb-3welcomeHead dd"
                            data-aos="fade-up"
                        >
                            Our Services
                        </h1>
                        <p
                            ...
                            data-aos-delay="100"
                        >
                            Discover amazing travel services across Pakistan
                        </p>
                        <nav
        ...
        <section class="py-5">
            <div class="container">
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="filterTabContent">
                                ...
                                >
                                    ...
                                    <div class="row g-2" id="categoryFilters">
                                ...
                                <div
                                    ...
                                    role="tabpanel"
                                >
                                    <h6 class="mb-3">Filter by Price Range</h6>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                    ...
                                    <div class="mt-3">
                                        <h6>Quick Price Ranges</h6>
                                        <div
                                            class="btn-group-vertical d-grid gap-2 d-md-block"
                                        >
                                            <button
                                                class="btn btn-outline-primary btn-sm"
                                            ...
                                            <button
                                                class="btn btn-outline-primary btn-sm"
                                                onclick="setPriceRange(10000, 999999)"
                                            >
                                                Above PKR 10,000
                                            </button>
                                        </div>
                                ...
                                <div
                                    ...
                                    role="tabpanel"
                                >
                                    <h6 class="mb-3">Filter by Rating</h6>
                                ...
                                <div
                                    ...
                                    role="tabpanel"
                                >
                                    <h6 class="mb-3">Sort Services</h6>
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <select
                                                class="form-select"
                ...
                >
                    ...
                    >
                        <div>
                            <span
                                id="resultsCount"
                                class="fw-bold text-green-primary"
                            ></span>
                            <span class="text-muted">services found</span>
                            <span id="activeFilters" class="ms-3"></span>
                        </div>
                ...
                >
                    ...
                    ></i>
                    <h3 class="dd welcomeHead">Welcome to Our Services</h3>
                    <p class="text-black">
                ...
                <div id="servicesSection" style="display: none">
                    <h3 id="cityTitle" class="mb-4" data-aos="fade-up"></h3>
